...
```sh
az container create -g aroworkshop -n loadtest --image hakkiogretmen/load-test --restart-policy Never --no-wait --environment-variables APPLICATION_URL=<public ip of service> TEST_DURATION=100 CONCURRENT_USER=100
